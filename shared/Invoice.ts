export class Invoice {
    ...
    constructor(invNr: number = 0, invDate: Date = new Date(), customer: string = '', incVAT: boolean = false, couponAmt: number = 0, items: InvItem[] = []) {
        this.invNr = invNr
...
export class InvItem {
    ...
    constructor(itemNr: number, invNr: number, name: string, qty: number, price: number, discount: number) {
        this.itemNr = itemNr
        this.invNr = invNr
        this.name = name
        this.qty = qty

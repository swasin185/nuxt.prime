<template>
    <Card>
        <template #title>Pascal's Triangle</template>
        <template #content>
            <canvas id="cpxCanvas" width="800" height="700" style="border: 1px solid #ffffff; background-image: url('/game/pascal.jpg')"></canvas>
        </template>
        <template #footer>
